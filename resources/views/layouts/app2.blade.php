                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            ...
                            <span style="font-size: 10px;" class="badge">
                                ...
                                <div class="dropdown-menu" style="min-width: 20rem !important ;padding: 1px;">
                                    ...
                                    @foreach ($userunreadnoti as $noti)
                                    <div class="row"
                                        ...
                                        <div class="col-9 text-left">
                                            <span>{{$noti->data['text']}}</span> code is <span
                                                style="color: red">{{$noti->data['code']}}</span>
                                        </div>
                                    </div>
                                    <hr style="margin: 3px;">
                                    @endforeach
                                    @foreach ($userreadnoti as $noti)
                                    <div class="row"
                        ...
                        <li class="nav-item d-none d-xl-block d-lg-block d-md-block" aria-labelledby="navbarDropdown">
                            <a style="color: white" class="nav-link" href="{{ route('logout') }}" onclick="event.preventDefault();
                ...
                <div class="container clearfix">
                    ...
                    <div class="userinfo row">
                        ...
                        <div style="color: black;display: inline-block" class="col-lg-5 col-md-4 col-sm-2">
                            ...
                            <h6>{{ Auth::user()->fisrtname }} {{ Auth::user()->thirdname }}</h6>
                            <h6>
