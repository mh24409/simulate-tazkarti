    ...
    <section class="sectionhome">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="cards">
                    <div class="card-body">
                        <h5 class="card-title"><img style="width: 90px;" src="{{asset('storage/images/sports.svg')}}"
                                alt=""></h5>
                ...
                <div class="cards2">
                    <div class="card-body">
                        <h5 class="card-title"><img style="width: 70px;" src="{{asset('storage/images/events.svg')}}"
                                alt=""></h5>
                ...
                <div class="  cards3">
                    <div class="card-body bg-green">
                        <h5 class="card-title"><img style="width: 70px;" src="{{asset('storage/images/more.svg')}}"
                                alt=""></h5>
            ...
            <div style="margin-top: 60px;">
                <div style="display: inline-block;">
                    <a style="color: white ; font-weight: bold;" class="nav-link" href="{{ route('login') }}"></i>
                        {{ __('Sign In') }}</a>

                </div>
                Or
                <div style="display: inline-block; background-color: rgb(15, 163, 15);">
                    <a style="color: white; font-weight: bold;" class="nav-link" href="{{ route('register') }}"> <i
                            class="fas fa-user-plus" style="font-size: 15px;"></i> {{ __('Register Now') }} </a>
                </div>
            </div>
