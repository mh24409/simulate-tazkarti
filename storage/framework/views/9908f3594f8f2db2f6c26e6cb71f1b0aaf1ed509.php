                                ...
                                <fieldset class="form-group">
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <div> <img style="height: 100px;float: right; margin-left: 20px;"
                                            src="<?php echo e(asset("storage/images/events/$event->eventimage")); ?>" alt=""></div>
                                    </div>
                                    <div class="row">
                            ...
                            <form method="POST" action="/storematchticket">
                                ...
                                <fieldset class="form-group">
                                    <div class="d-flex justify-content-between">
                                        <div><img style="height: 60px;margin-top: 10px;margin-bottom: 10px; width: 70px"
                                            src="<?php echo e(asset("storage/images/matches/$match->hometeamlogo")); ?>" alt=""></div>
                                        <div style="margin-top: 20px">VS</div>
                                            <div><img style="height: 60px; margin-top: 10px;margin-bottom: 10px; width: 70px"
                                            src="<?php echo e(asset("storage/images/matches/$match->awayteamlogo")); ?>" alt=""></div>
                                    </div>
                                    <div class="d-flex justify-content-center" > <img style="height: 150px; margin-top: 10px;margin-bottom: 10px; width: 250px"
...
<?php echo $__env->make('layouts.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\web\tazkartii\resources\views/index.blade.php ENDPATH**/ ?>