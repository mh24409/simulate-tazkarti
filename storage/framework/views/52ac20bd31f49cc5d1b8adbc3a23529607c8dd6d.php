...
<body>
    <div id="app">
        <nav class="navbar navbar-expand navbar-light shadow-sm fixed-top  ">
            <div class="container">
                <a class="navbar-brand" href="<?php echo e(url('/index')); ?>">
                    <img style="height: 35px" src="<?php echo e(asset("storage/images/download.svg")); ?>" alt="">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item d-none d-xl-block d-lg-block d-md-block ">
                            <a style="color: white" class="nav-link" href="<?php echo e(route('register')); ?>"> <i
                                    class="fas fa-user-plus" style="font-size: 15px;"></i> <?php echo e(__('Register')); ?> </a>
                        </li>
                        ...
                        <!-- login -->
                        <li class="nav-item d-none d-xl-block d-lg-block d-md-block">
                            <a style="color: white" class="nav-link" href="<?php echo e(route('login')); ?>"><i
                                    class="fas fa-unlock" style="font-size: 15px;"></i> <?php echo e(__('Login')); ?></a>
                        </li>
                        <li class="nav-item d-lg-none d-xl-none d-md-none">
                            <a style="color: white" class="nav-link" href="<?php echo e(route('login')); ?>"><i
                        ...
                        <li class="nav-item">
                            <select name="" id="" class="custom-select"
                                style="background-color: unset; border: unset; color: white">

                                <option style="color: black" value=""> <a class="nav-link"
                                        href="#"><?php echo e(__('English')); ?></a></option>
                                <hr>
                                <option style="color: black" value=""> <a class="nav-link"
                                        href="#"><?php echo e(__('العربية')); ?></a></option>
                            </select>
                        </li>
                        <?php else: ?>
...
</html><?php /**PATH E:\web\my projects\tazkartii\resources\views/layouts/app.blade.php ENDPATH**/ ?>